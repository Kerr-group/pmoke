...
const COPY = {
  en: {
    ...
    unsupportedList: 'FIR · sync IIR · phase fitting · standard Kerr',
  ...
  ja: {
    source: '入力', synthetic: '合成波形', csv: 'ローカル CSV', upload: 'CSV 選択',
    noFile: 'ファイル未選択', run: '解析実行', cancel: '解析中断', reset: '初期化',
    retry: 'コア再読込', loading: '解析コア読込中', ready: '実行待機', running: '解析中',
    ...
    filter: 'フィルター', filterValue: '従来型 Boxcar', parity: 'ネイティブ完全一致',
    unsupported: 'ブラウザ一致対象外', export: 'CSV 出力', copy: '要約コピー', copied: '要約コピー済み',
    samples: 'サンプル数', sampleRate: 'サンプルレート', frequency: '参照周波数', amplitude: '振幅',
    phase: '信号位相', noise: 'ノイズ RMS', angle: 'Kerr 角', window: '半窓周期',
    stride: 'ストライド', harmonic: '高調波', rotation: '位相回転', factor: 'Kerr 係数', seed: '乱数種',
    ...
    responseUnit: '周波数 (Hz)', csvHint: 'time,signal または信号単列・有限等間隔値',
    uploadLimit: '16 MiB / 1,000,000 点', local: 'ブラウザ内処理',
    unsupportedList: 'FIR・同期 IIR・位相フィッティング・標準 Kerr',
    stagePrepare: '波形準備', stageLockin: 'Lock-in 高調波', stageKerr: 'Harmonics Kerr 計算',
    stageDecimate: '表示用間引き', stageComplete: '解析完了',
    warningLong: '長い Boxcar 窓による時間分解能低下',
    warningSparse: '参照周波数に対して疎な出力サンプリング',
    warningLocal: 'ローカル CSV のブラウザセッション内保持',
  },
} as const;
