...
description: Build a schema v6 configuration around signal roles and artifacts.
---
...
Raw-signal readout is optional. Each `[[signals]]` entry averages one channel
over the lock-in window:
