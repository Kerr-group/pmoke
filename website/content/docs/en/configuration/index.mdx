...
Each sensor has exactly one scale form. The reference channel drives frequency
and phase estimation. Lock-in signal channels contain the optical response.
