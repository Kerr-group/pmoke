...
Validation covers TOML syntax, unknown v6 keys, ranges, channel roles, filter
...
The tool validates canonical schema v6 in a dedicated Web Worker. Input remains in
