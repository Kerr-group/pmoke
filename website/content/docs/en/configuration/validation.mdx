...
The tool validates canonical schemas v6 and v7 in a dedicated Web Worker. Input remains in
the browser. Driver availability, filesystem state, Python packages, and hardware
reachability remain native `pmoke doctor` checks. Migrate v1-v5 files before browser
validation.
