...
pub use calibration::{
    ...
    DEFAULT_SHRINKAGE_ALPHA, HeldoutReport, MAX_CALIBRATION_ARTIFACT_BYTES, ModelBinding,
    NUISANCE_HARMONICS, NUISANCE_PARAMETERS, NuisanceFit, PhaseTable, PhaseVarianceOutput,
    PhaseVarianceRecipe, PlannedBlock, PlannedExclusion, RegularizationRecord, RoleInterval,
    SearchSpace, TrainingRecord, TuningMode, VARIANCE_INTERP_ID, ValidationRecord,
    assemble_samples, build_artifact, ensure_fixed_tuning, estimate_correlation,
    estimate_phase_variance, fit_nuisance, inspect_applicability, nuisance_design_matrix,
